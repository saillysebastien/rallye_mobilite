...
if ($_POST) {
  ...
  if (isset($_POST['id']) && !empty(trim($_POST['id']))) {
    ...
    $valid = false;
    $errors['id_post'] = "<div class='alert alert-danger'>Vous devez remplir l'id!</div>";
  }
  ...
  if (isset($_POST['street']) && !empty(trim($_POST['street']))) {
    ...
    $valid = false;
    $errors['street'] = "<div class='alert alert-danger'>Vous devez indiquer l'adresse!</div>";
  }
  ...
  if (isset($_POST['postal_code']) && !empty(trim($_POST['postal_code']))) {
    ...
    $valid = false;
    $errors['postal_code'] = "<div class='alert alert-danger'>Vous devez indiquer le code postal!</div>";
  }
  ...
  if (isset($_POST['city']) && !empty(trim($_POST['city']))) {
    ...
    $valid = false;
    $errors['city'] = "<div class='alert alert-danger'>Vous devez indiquer la ville!</div>";
  }
  ...
  if (isset($_POST['domain_activity']) && !empty(trim($_POST['domain_activity']))) {
    ...
    $valid = false;
    $errors['domain_activity'] = "<div class='alert alert-danger'>Vous devez indiquer le domaine d'activité!</div>";
  }
  ...
  if (isset($_POST['image2']) && !empty(trim($_POST['image2']))) {
    ...
    $valid = false;
    $errors['image'] = "<div class='alert alert-danger'>Vous ne pouvez pas enlever l'image!</div>";
  }
  ...
  if ($valid) {
    ...
    $informations['success'] = "<div class='alert alert-success center'>Entreprise $title modifiée </div>\n
    <br />
