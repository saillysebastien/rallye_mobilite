...
if (isset($_POST['upload_rebus'])) {
  ...
  $update = sprintf("UPDATE appli SET title='gpe3pg3', name='$name', one='$one', two='$two', three='$three', four='$four', five='$five', indice='$index', response='$response', question ='$question', my_all='$my_all', image='$image', qrcode='$qrcode' WHERE id='23'");
...
if ($update_db) {
  ...
  <div class="container text-center">
    <a class="btn btn-info" href="steps4.php">Passer à l\'étape 2</a>
  </div>
  ');
}
